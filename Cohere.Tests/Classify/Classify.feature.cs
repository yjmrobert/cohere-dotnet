...
namespace Cohere.Tests.Classify
{
    ...
    public partial class ClassifyFeature : object, Xunit.IClassFixture<ClassifyFeature.FixtureData>, Xunit.IAsyncLifetime
    {
...
#line hidden
        ...
        public ClassifyFeature(ClassifyFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static async System.Threading.Tasks.Task FeatureSetupAsync()
        {
            ...
            global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Classify", "Classify", "  As a developer\r\n  I want to use the CohereClient class to interact with the Coh" +
...
#line hidden
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.InitializeAsync()
            {
                await ClassifyFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.DisposeAsync()
            {
                await ClassifyFeature.FeatureTearDownAsync();
            }
        }
    }
}
